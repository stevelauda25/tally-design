    ...
    >
      ...
      <section id="source-of-truth" className="flex h-16 w-full flex-col gap-1 px-3">
        ...
        <p className="text-sm leading-5 font-normal text-text-secondary">
          ...
          approved Figma Logo frame at node{" "}
          <a
            href="https://www.figma.com/design/wGZ7iBXcVtfRhr5sxqGMAh/Rhino-Labs--July-2026----Tally-Inventory?node-id=2136-4329&t=6zlAzfu4d7Hx4hzm-11"
            target="_blank"
            rel="noreferrer"
          >
            <InlineCode>2136:4329</InlineCode>
          </a>{"."}
        </p>
      </section>
    </DocsShell>
